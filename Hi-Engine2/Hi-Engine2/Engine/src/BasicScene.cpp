...
{
	WorldOutliner::AddObject(new Wall(FPosition({ 0, 0 }), "Wall_Top", "бс", Area({ 5, 3 }), "Wall"));
	...
	WorldOutliner::AddObject(new Wall(FPosition({ 5, float(6) - 1 }), "Wall_Bottom", "бс", Area({ Size, 1 }), "Wall"));
